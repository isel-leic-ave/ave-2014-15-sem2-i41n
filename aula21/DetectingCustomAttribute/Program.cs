...
public sealed class Program
{
    ...
    private static void ShowAttributes(MemberInfo attributeTarget)
    {
        ...
        bool isDefined = Attribute.IsDefined(attributeTarget, typeof(DllImportAttribute));

        /*
        ConditionalAttribute[] theSameAttributes = (ConditionalAttribute[])
            attributeTarget.GetCustomAttributes(typeof(ConditionalAttribute));
        */
